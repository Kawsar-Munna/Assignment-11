  ...
  const handleAddPost = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(`Server responded with ${res.status}: ${message}`);
      }
      ...
      <div className="bg-white text-black dark:bg-[#070e22] dark:text-white">
        ...
        <div className="max-w-3xl mt-4 mx-auto p-6 shadow-lg rounded-xl my-12 border border-gray-200 text-white dark:bg-[#070e22] dark:text-white">
          ...
          <form onSubmit={handleAddPost} className="space-y-6">
            <div>
              <label className="block text-lg font-medium text-[#ffbd59] mb-2">
                Thumbnail URL
              </label>
              <input
                name="thumbnail"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="w-full px-4 py-2 bg-gray-100 border rounded text-black text-lg"
                />
              </div>
              <div>
                <label className="block text-lg font-medium text-[#ffbd59] mb-2">
